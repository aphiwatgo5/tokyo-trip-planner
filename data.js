...
{date:"2026-11-28", d:"28 พ.ย.", dow:"เสาร์ · D1", tag:"วันพัก", pace:"rest", zone:"อูเอโนะ (ใกล้บ้าน)",
  ...
  variants:[{name:"แผนหลัก", rows:[
    R("06:55–08:00","เครื่องลง Haneda (T3) + ตม.","Haneda","","~1 ชม.",0,0,"logistic","",415,60),
    ...
    R("13:30–16:00","งีบยาว","โรงแรม","","","",0,0,"rest","เช็กอิน 15:00",810,150),
...
{date:"2026-11-30", d:"30 พ.ย.", dow:"จันทร์ · D3", tag:"วันหนัก", pace:"big", zone:"ไมฮามะ (ตะวันออก)",
  ...
  variants:[{name:"แผนหลัก", rows:[
    ...
    R("13:00–15:00","งีบในรถเข็น + เครื่องเล่นเด็ก","ในสวน","","","",0,0,"rest","",780,120),
...
{date:"2026-12-02", d:"2 ธ.ค.", dow:"พุธ · D5", tag:"วันเบา", pace:"light", zone:"โทโยซุ (ตะวันออก) + บ้าน",
  ...
  variants:[{name:"แผนหลัก", rows:[
    ...
    R("14:00–16:30","งีบยาว + อาบน้ำ + พักจริงจัง","โรงแรม","","","",0,0,"rest","วันนี้ตั้งใจพัก — รีเซ็ตก่อนครึ่งหลังทริป",840,150),
...
{date:"2026-12-03", d:"3 ธ.ค.", dow:"พฤหัส · D6", tag:"วันกลาง", pace:"med", zone:"ซุอิโดบาชิ–บุงเกียว (ติดบ้าน)",
  ...
  variants:[{name:"แผนหลัก", rows:[
    ...
    R("14:00–15:45","งีบ + พัก","โรงแรม","","","",0,0,"rest","",840,105),
...
{date:"2026-12-04", d:"4 ธ.ค.", dow:"ศุกร์ · D7", tag:"วันกลาง", pace:"med", zone:"กลางเมือง: หน้าสถานีโตเกียว–ชินางาวะ",
  ...
  variants:[{name:"แผนหลัก", rows:[
    ...
    R("14:00–15:30","งีบ","โรงแรม","","","",0,0,"rest","",840,90),
...
{date:"2026-12-05", d:"5 ธ.ค.", dow:"เสาร์ · D8", tag:"วันเบา", pace:"light", zone:"อูเอโนะ + สกายทรี (ปิดท้ายใกล้บ้าน)",
  ...
  variants:[{name:"แผนหลัก", rows:[
    ...
    R("10:30–12:00","เก็บกระเป๋า + พัก","โรงแรม","","","",0,0,"rest","แพ็กให้เสร็จก่อนออกรอบเย็น — พรุ่งนี้บิน 10:35",630,90),
    R("12:00–13:00","มื้อกลางวัน","ร้านแถว Ueno","เดิน","",0,2800,"food","",720,60),
    R("13:00–14:45","งีบบ่ายสุดท้าย","โรงแรม","","","",0,0,"rest","",780,105),
...
{date:"2026-12-06", d:"6 ธ.ค.", dow:"อาทิตย์ · D9", tag:"กลับ", pace:"rest", zone:"กลับกรุงเทพฯ",
  ...
  variants:[{name:"แผนหลัก", rows:[
    ...
    R("10:35","","Haneda → BKK","TG683","","","","","","ถึง BKK 15:40",635,0),
  ]}]},
];

const SEED = {
  meta: { filename: "Tokyo_Trip_Working_Plan_2026.xlsx", loadedAt: "2026-09-06T00:00:00Z", source: "seed", schema: 4 },
  settings: {
...
function migrate(state){
  ...
  if(state.meta.schema>=4) return state;
